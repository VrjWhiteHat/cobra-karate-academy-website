...
const DEFAULT_CONTENT = {
  ...
  gallery: [{ src: "/manus-storage/dojo-wide_9b8a98e6.jpg", alt: "Karate athlete training in a dojo", label: "The room is ready" }, { src: "/manus-storage/kick-motion_d21625b0.jpg", alt: "Martial artist in a powerful kick", label: "Power, controlled" }, { src: "/manus-storage/kata-practice_adf6877b.jpg", alt: "Athlete practicing a kata sequence", label: "Form in motion" }, { src: "/manus-storage/dojo-space_e988f290.jpg", alt: "Modern martial arts training space", label: "Built for the work" }],
